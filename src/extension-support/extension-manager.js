...
const Scratch3DictionaryBlocks = require('../extensions/scratch3_dictionary'); // custom extension stuff
const Scratch3GraphBlocks = require('../extensions/scratch3_graph');
...
const builtinExtensions = {
    ...
    dictionary: Scratch3DictionaryBlocks, // custom extension stuff
    graph: Scratch3GraphBlocks
